using Better.Spectre.Console.CLI.Internal.Configuration;
...
/// </summary>
#if !NETSTANDARD2_0
[RequiresDynamicCode("Better.Spectre.Console.CLI relies on reflection. Use during trimming and AOT compilation is not supported and may result in unexpected behaviors.")]
#endif
